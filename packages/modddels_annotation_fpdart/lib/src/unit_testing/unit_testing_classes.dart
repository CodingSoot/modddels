...
import 'package:modddels_annotation_fpdart/src/unit_testing/base_tester.dart';
...
///
/// A [ModddelParams] represents the parameters of a modddel.
///
abstract class ModddelParams<M extends BaseModddel> extends Equatable {
  ...
  /// Returns a modddel instantiated with the parameters of this
  /// [ModddelParams].
  M toModddel();

  /// Returns the [ModddelParams] that are held by the modddel after being
  /// instantiated with the parameters of this [ModddelParams].
  ///
